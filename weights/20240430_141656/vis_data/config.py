...
class_name = ('airplane', 'ship', 'vehicle')
num_classes = 3
metainfo = dict(classes=('airplane', 'ship', 'vehicle'), palette=[(255, 0, 0)])
backend_args = None
train_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/data/coco_minitrain_25k/images',
        metainfo=dict(
            classes=('airplane', 'ship', 'vehicle'), palette=[(255, 0, 0)]),
...
log_level = 'INFO'
load_from = 'weights/faster_rcnn_hrnetv2p_w40_2x_coco_20200512_161033-0f236ef4.pth'
resume = False
launcher = 'none'
work_dir = 'weights'
